...
export default function Contact() {
  ...
  return (
    <>
      ...
      >
        <div style={{ position:'absolute', top:-60, right:-60, width:360, height:360, borderRadius:'50%', background:'radial-gradient(circle, rgba(200,168,75,0.09), transparent 65%)', pointerEvents:'none' }} />
        <FadeIn>
