  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ position: 'absolute', bottom: -60, left: -60, width: 320, height: 320, borderRadius: '50%', background: 'radial-gradient(circle, rgba(14,99,61,0.15), transparent 65%)', pointerEvents: 'none' }} />
        <FadeIn>
